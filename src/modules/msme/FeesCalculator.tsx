                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 overflow-hidden">
                    ...
                    <div className="lg:col-span-7 p-4 md:p-6 space-y-6 border-r border-border/50">
                        <div className="space-y-6">
                            ...
                            <div className="p-4 bg-accent/30 border border-border/40 rounded-xl flex items-center justify-between group transition-all duration-300 share-row">
                    ...
                    <div className="lg:col-span-5 p-4 md:p-6 bg-muted/30 flex flex-col justify-center space-y-6">
                        <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 gap-4">
                                <div className="stat-card p-4 rounded-xl border border-border/50 bg-background shadow-sm flex items-center justify-between share-row">
